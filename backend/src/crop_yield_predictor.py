    ...
    def predict(self, feature_dict: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for crop_id, model in CROPS_AGRONOMIC_MODELS.items():
            ...
            if opt_ph_min <= ph <= opt_ph_max:
                ...
                ph_limiting = (
                    f"Acidez/Alcalinidad fuera de rango óptimo ({opt_ph_min} - {opt_ph_max})"
                )
            ...
            if compaction_idx > 0.4 and crop_id in ["maiz_blanco", "soya", "arroz"]:
            ...
            elif forest_hist_ratio > 0.4 and crop_id in [
                "cacao_criollo",
                "cafe_arabica",
                "platano",
            ]:
                ...
                mapbiomas_limiting = (
                    "Suelo con fatiga de monocultivo continuo histórico (MapBiomas)"
                )
            ...
            predictions.append(
                {
                    ...
                    "mapbiomas_legacy_impact": {
                        ...
                        "soil_legacy_status": (
                            "Favorable"
                            if mapbiomas_modifier >= 1.0
                            else "Requiere Enmienda/Descompactación"
                        ),
                    },

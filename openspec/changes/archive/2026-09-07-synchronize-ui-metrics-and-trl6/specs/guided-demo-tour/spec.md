...
5. Ficha Técnica Institucional TRL 6.
...
- **THEN** the modal displays the TRL 6 maturity highlight and provides an action button to open the institutional postulation profile.

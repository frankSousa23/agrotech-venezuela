...
The system SHALL provide a comprehensive `.env.production.example` file detailing all required production environment variables (Database URL, JWT secret, FastAPI backend URL, and Google Gemini API credentials) with descriptive configuration guidelines.

...
const TOUR_STEPS: TourStep[] = [
  ...
  {
    title: "Madurez TRL 4, MRV de Carbono & APIs OpenAPI",
    badge: "Paso 5 de 5 • Validación",
    badgeColor: "#38bdf8",
    icon: Award,
    description: "Prototipo funcional validado en entorno de desarrollo (TRL 4 con 278 tests), con cuantificación prospectiva de secuestro de carbono orgánico (SOC) bajo IPCC Tier 2 y catálogo de 39 APIs REST.",
    highlights: [
      ...
      "Ecosistema de microservicios contenerizado y validado con 278 tests (224 Jest + 54 Pytest)."
    ],

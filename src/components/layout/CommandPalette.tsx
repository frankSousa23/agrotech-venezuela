...
export default function CommandPalette() {
  ...
  const allItems: PaletteItem[] = useMemo(() => {
    const tools: PaletteItem[] = [
      ...
      { id: 'tool-carbon', category: 'Herramientas', title: '🌱 Calculadora de Créditos de Carbono MRV', subtitle: 'Cuantificación SOC y valoración económica IPCC Tier 2', icon: <Sprout size={16} color="#10b981" />, url: '/dashboard/recomendaciones#carbon-credits' },
      { id: 'tool-machinery', category: 'Herramientas', title: '🚜 Prescripciones VRA para Maquinaria & Drones', subtitle: 'Exportación de mapas de tasa variable en ESRI Shapefile y KML', icon: <Tractor size={16} color="#38bdf8" />, url: '/dashboard/recomendaciones' },

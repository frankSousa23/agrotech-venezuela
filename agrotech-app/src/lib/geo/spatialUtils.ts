...
/**
 * Algoritmo Multicriterio Edafo-Agrícola para calcular Idoneidad de Cultivos
 */
...
/**
 * Calculadora de Prescripción y Enmiendas Edafológicas
 */
export function calculateSoilAmendments(
  ...
  if (needsLiming) {
    // Fórmula de requerimiento de cal (CaCO3) en función del déficit de pH
  ...
  } else if (targetCropName.toLowerCase().includes('cacao')) {
    n = 80; p = 40; k = 100; formula = 'Fórmula Cafetalera/Cacaotera 10-20-20';
  ...
  if (organicMatterNeededTonsHa > 0) {
    technicalNotes.push(`Incorporar ${organicMatterNeededTonsHa} Ton/ha de abono orgánico o compost maduro para reactivar la microbiología.`);
  }
